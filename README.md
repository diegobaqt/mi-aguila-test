...
**NOTA 2:** Probablemente se generen problemas con el método *Trip/AddAll* en la base de datos desplegada, debido a que existen restricciones en la cantidad de registros en su configuración. Pero, localmente funciona perfectamente, así como en cualquier otra infraestructura sin esta restricción.
